...
while True:
    ...
    if line == "1,0_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin0.value(1)
    elif line == "1,0_OFF":
        led_pin0.value(0)

    if line == "1,1_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin1.value(1)
    elif line == "1,1_OFF":
        led_pin1.value(0)

    if line == "1,2_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin2.value(1)
    elif line == "1,2_OFF":
        led_pin2.value(0)

    if line == "1,3_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin3.value(1)
    elif line == "1,3_OFF":
        led_pin3.value(0)

    if line == "1,4_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin4.value(1)
    elif line == "1,4_OFF":
        led_pin4.value(0)

    if line == "1,5_ON":  # 2차원 좌표라고 생각하면 됌요
        led_pin5.value(1)
    elif line == "1,5_OFF":
        led_pin5.value(0)